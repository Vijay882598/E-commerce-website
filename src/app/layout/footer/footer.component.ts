...
export class FooterComponent {
  ...
  paymentMethods = [
    ...
    { name: 'PayPal', src: 'https://static.wixstatic.com/media/84770f_8445424a46ca49f39359bf19d4a3e537~mv2.png/v1/fill/w_110,h_76,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/PayPal.png' },
    { name: 'American Express', src: 'https://static.wixstatic.com/media/c837a6_2bd3e20d1e214eccb5e106fc6d1f535d~mv2.png/v1/fill/w_110,h_58,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/brand-amex%403x.png' }
  ];
  ...
  footerLinks = {
    shop: [
      ...
      { label: 'Computers', url: '/products/computers' },
      { label: 'Tablets', url: '/products/tablets' },
      { label: 'Audio', url: '/products/audio' }
    ],
    support: [
